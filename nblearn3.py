...
def Learn(root_dir):
    ...
    for cl in bag_of_words:
        ...
        for word in bag_of_words[cl]:
            probab_conditional[cl][word] = math.log(bag_of_words[cl][word] + 1) - math.log(class_count + vocab_count_total)
...
if __name__ == "__main__":
    root_dir = sys.argv[1]
    naive_bayes_learn = Learn(root_dir)
